...
export function BottomNav({ role }: { role: string }) {
  ...
  return (
    <nav className="fixed left-0 right-0 bg-background border-t z-50" data-testid="bottom-nav" style={{ bottom: "-1px", paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 1px)" }}>
