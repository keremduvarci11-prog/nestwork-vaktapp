...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="fixed top-0 left-0 right-0 bg-background/95 backdrop-blur border-b z-40">
      ...
      <main className="max-w-lg mx-auto px-4 pt-4 pb-24" style={{ marginTop: "48px" }}>
        <PullToRefresh>
        <Switch>
          {isAdmin ? (
            <>
